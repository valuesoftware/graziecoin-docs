...
|   5   | ユーザ登録フォーム有効スイッチ     |   -   | ユーザ登録フォームからのユーザ登録の有効・無効を切り替えるスイッチです                                                             |
|   6   | ユーザ登録URL                      |   -   | ユーザ登録フォームのURLを表示します                                                                                                |
|   7   | メールアドレスドメイン制限スイッチ |   -   | ユーザ登録フォームから登録するユーザのメールアドレスを、マスター管理者と同じドメインとする制限の有効・無効を切り替えるスイッチです |
|   8   | URLをコピーボタン                  |   -   | ボタンを押すとユーザ登録URLをクリップボードにコピーします                                                                          |
|   9   | URLを再発行するボタン              |   -   | ボタンを押すとユーザ登録URLをランダムに生成しなおします                                                                            |
