...
### グラッチェを送る(メッセージ入力)画面へ移動　
  - グラッチェの直近5件の取引履歴に表示されているユーザ名の下部にある「返信」をタップすると、表示されているユーザにグラッチェすることができます
...
:new:在庫がない商品は、ボタンが「**在庫切れ**」と表示されます。
...
:new: 青い下線が表示されているユーザ名をタップすると、**グラッチェ入力画面に遷移します**
