...
|   4   | パスワード再設定メール送信   |   -   | ボタンを押すとパスワード再設定メールを、ログインユーザのメールアドレスを送信します |
|   5   | サムネイル範囲選択編集 |   -   | 選択した画像から、サムネイルに設定する範囲を編集できます |
|   6   | 閉じるボタン |   -   | 変更を破棄し、元の画面に戻ります |
|   7   | サムネイル変更ボタン |   -   | 確認メッセージを表示します |
